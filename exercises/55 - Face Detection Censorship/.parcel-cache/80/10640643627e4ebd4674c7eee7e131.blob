...
optionsInputs.forEach(input => input.addEventListener('in')); // populate video as an assync function with getUserMedia
...
//# sourceMappingURL=pixelated-face.33b207a7.js.map
