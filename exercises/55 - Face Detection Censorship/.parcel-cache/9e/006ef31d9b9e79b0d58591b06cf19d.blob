...
async function detect() {
  const faces = await console.log(faces); // ask the browser when next animation frame happens to run something for us
...
//# sourceMappingURL=pixelated-face.869e28a5.js.map
